...
<body>
	<div style="width:100%; height:100%;">
		<div style="width:100%; height:10%; background-color:black; color:white; text-align:center;">
			<h1>Order Your Medicines Online</h1>
		</div>
		...
		<div style="width:100%; height:80%;">
			<form name="proname" align="center" method="get" action="CartList.jsp">
				...
				<input type="text" value="Quantity"disabled class="medi">
				<input type="number" name="Units" placeholder="No Of Units" class="medi"><br>
				
				<span id="seller" name="dispp"></span>
				
				
				<input type="submit" name="submit" value="Add To Cart" class="medi">
			</form>
		</div>
	</div>
</body>